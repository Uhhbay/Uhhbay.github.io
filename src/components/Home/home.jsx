...
export default function Home() {
    return (
      <section className="flex flex-col xl:flex-row mx-auto mt-16 h-[850px] bg-transparent">
        <div className="h-full w-full xl:w-1/2 bg-transparent flex items-center justify-center order-1 xl:order-2 animate-image">
          <div className="h-[530px] w-[90%] max-w-[390px] bg-white mr-0 xl:mr-60 mb-20 shadow-2xl shadow-gray-500 transition-transform duration-300 hover:scale-105">
        ...
        <div className="h-full w-full xl:w-3/4 bg-transparent flex items-center justify-center order-2 xl:order-1 animate-text">
          <div className="w-[415px] sm:w-[455px] xl:w-[800px] ml-0 xl:ml-48 xl:pr-48 pb-32 text-left">
            <h1 className="text-white text-4xl mb-4 pt-4 font-ubuntu">Hello,</h1>
            <h1 className="text-white text-custom font-ubuntu mb-20"> I'm { }
              <TypingEffect
                text={["Abhay Singh", "a Software Engineer", "a lifelong learner"]}
            ...
            <div className="flex flex-wrap gap-4 mt-10">
              <a href="https://docs.google.com/document/d/175HrAfWACDZBp7tJiKOD-_aGr6Yb3WHCob_NtTaXEXo/edit?usp=sharing" target="_blank" rel="noopener noreferrer">
                <button className="bg-gray-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-md hover:bg-white hover:text-customBlue">
                  Resume
              ...
              <a href="https://github.com/Uhhbay" target="_blank" rel="noopener noreferrer">
                <button className="bg-gray-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-md hover:bg-white hover:text-gray-800"> 
              ...
              <a href="https://www.instagram.com/uhh_bay/" target="_blank" rel="noopener noreferrer">
                <button className="bg-gray-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-md hover:bg-white hover:text-pink-500"> 
